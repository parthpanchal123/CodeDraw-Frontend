...
const Rootpage = () => {
  ...
  return (
    <div className="w-full overflow-hidden" id="main-container">
      <div className="leading-normal tracking-normal text-indigo-400 bg-bg bg-center w-full h-full font-body ">
        ...
        <div className="container h-5/6 p-2 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className=" xl:w-6/12 p-2 overflow-hidden " id="graphic">
            <img
